...
RUN_DIR = f"runs/twhin_lora_run_{timestamp}"
...
# ======================================================
# 6. TRAINING ARGUMENTS (old-HF safe)
# ======================================================
training_args = TrainingArguments(
    ...
    weight_decay=0.01,
    logging_steps=20,
    save_strategy="no",   # manual checkpointing only
)
...
trainer = Trainer(
    ...
    # Remove 'tokenizer=tokenizer' if it fails, or use:
    # data_collator=None, 
...
# ======================================================
# 8. CUSTOM TRAIN LOOP — manual "best model" saving
# ======================================================
best_acc = -1
best_epoch = -1
...
# ======================================================
# 10. FINAL EVALUATION + FULL REPORT
# ======================================================
metrics = trainer.evaluate()
